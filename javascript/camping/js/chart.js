...
!(function (t, e) {
  ...
  function Pi(t, e, i, s) {
    ...
    for (o = 0, a = t.length; o < a; ++o)
      if (
        ((r = t[o]),
        void 0 !== r &&
          (void 0 !== e && "function" == typeof r && ((r = r(e)), (l = !1)), void 0 !== i && n(r) && ((r = r[i % r.length]), (l = !1)), void 0 !== r))
      )
    ...
    return s && s.setContext && i
      ? (function (t, e, i, s) {
          ...
          for (const t of e) {
            ...
            for (u = d + 1; u <= t.end; u++) {
              const r = i[u % l];
              (e = Vi(s.setContext(Ci(n, { type: "segment", p0: o, p1: r, p0DataIndex: (u - 1) % l, p1DataIndex: u % l, datasetIndex: a })))),
      ...
      for (x = 0, _ = l.length; x < _; ++x) {
        ...
        if (
          (r
            ? ((M = S),
              "inner" === k &&
                (f = x === _ - 1 ? (this.options.reverse ? "left" : "right") : 0 === x ? (this.options.reverse ? "right" : "left") : "center"),
              (O =
                "top" === s
                  ? "near" === c || 0 !== m
                    ? -C * D + D / 2
  ...
  var uo = Object.freeze({
    ...
    BarElement: class extends Hs {
      ...
      draw(t) {
        ...
        var r;
        t.save(),
          (o.w === n.w && o.h === n.h) || (t.beginPath(), a(t, co(o, e, n)), t.clip(), a(t, co(n, -e, o)), (t.fillStyle = i), t.fill("evenodd")),
          t.beginPath(),
          a(t, co(n, e)),
          (t.fillStyle = s),
          t.fill(),
  ...
  class mo extends Js {
    ...
    buildTicks() {
      ...
      const n = (function (t, e) {
        ...
        let D = 0;
        for (
          b && (u && M !== a ? (i.push({ value: a }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, po(a, y, t)) && D++) : M < a && D++);
          D < k;
          ++D
        ) {
  ...
  const ma = (t, e) => {
    ...
    return (
      t.usePointStyle && ((i = Math.min(i, e)), (s = t.pointStyleWidth || Math.min(s, e))), { boxWidth: s, boxHeight: i, itemHeight: Math.max(e, i) }
    );
  };
  class ba extends Hs {
    constructor(t) {
    ...
    _drawArgs(t) {
      ...
      return (
        this.isHorizontal()
          ...
          : ("left" === o.position ? ((l = i + t), (h = ft(a, s, e)), (c = -0.5 * C)) : ((l = n - t), (h = ft(a, e, s)), (c = 0.5 * C)), (r = s - e)),
